...
[TIP]
====
You can install and demo Netrics software with Docker. Follow our [guide on the netrics-docker GitHub repository](https://github.com/internet-equity/netrics-docker/tree/main) to get started.
====
