...
[TIP]
====
You can install and demo Netrics software with Docker. Follow our https://github.com/internet-equity/netrics-docker/tree/main[guide on the netrics-docker GitHub repository] to get started.
====
...
[IMPORTANT]
====
While Netrics is in beta, the installation argument `--pre` must be appended to the below. For example:

[source,sh]
----
curl -sL https://github.com/internet-equity/netrics/raw/0.0.1-rc.18/install.py | python3 - --pre
----
====
