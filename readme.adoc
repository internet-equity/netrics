...
[source,sh]
----
curl -L https://github.com/internet-equity/netrics/raw/0.0.1-rc.11/install.py | python3
----
...
[source,sh]
----
curl -L https://github.com/internet-equity/netrics/raw/0.0.1-rc.11/install.py | python3 - --help
----
====
...
[source,console]
----
curl -LO https://github.com/internet-equity/netrics/raw/0.0.1-rc.11/install.py
