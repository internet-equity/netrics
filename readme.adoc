...
[source,sh]
----
curl -sL https://github.com/internet-equity/netrics/raw/0.0.1-rc.12/install.py | python3
----
...
[source,sh]
----
curl -sL https://github.com/internet-equity/netrics/raw/0.0.1-rc.12/install.py | sudo python3
----
...
[source,sh]
----
curl -sL https://github.com/internet-equity/netrics/raw/0.0.1-rc.12/install.py | python3 - --help
----
====
